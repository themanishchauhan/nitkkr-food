export const AUNTY_JI_TEA_STALL_VENDOR = {
  id: 33,
  name: 'Aunty Ji Tea Stall',
  slug: 'aunty-ji-tea-stall',
  phone: '7056688037',
  whatsapp: '7056688037',
  address: 'Near Campus Gate, Kurukshetra',
  latitude: '29.947418042627643',
  longitude: '76.82293216149863',
  opensAt: '07:00',
  closesAt: '22:00',
  deliversTo: ['Campus wide', 'Hostels & Departments'],
...
export const AUNTY_JI_TEA_STALL_MENU_ITEMS = [
...
export const ANTY_JI_TEA_STALL_VENDOR = AUNTY_JI_TEA_STALL_VENDOR;
export const ANTY_JI_TEA_STALL_MENU_ITEMS = AUNTY_JI_TEA_STALL_MENU_ITEMS;
